    ...
    <div id="app" class="min-h-screen py-24">
        <section class="max-w-lg mx-auto shadow-lg p-4 rounded-lg">
            <div class="flex justify-center">
                <img src="{{ asset('assets/img/logo/app-logo.png') }}" class="h-28" alt="FlowBite Logo" />
            </div>
            <h1 class="text-xl text-center font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                Selamat Datang Di Survey Aplikasi <br> <span>Info Aplikasi</span>
            </h1>
            <form action="{{ route('survey.store', ) }}" method="POST" class="w-full mx-auto mt-4">
                @csrf
